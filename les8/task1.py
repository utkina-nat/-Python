...
class Data:
    def __init__(self, day, month, year, day_month_year):
        self.day = day
        self.month = month
        self.year = year
    ...
    def toString(self, logFormat=True):
        return self.__str__() if logFormat else self.__repr__()
    ...
    def extract(cls, day_month_year):
        ...
        return cls(int(my_date[0])), int(my_date[1]), int(my_date[2])
